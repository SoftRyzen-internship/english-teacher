...
export const BenefitsCard = ({ title, name, text }: BenefitsCardProps) => {
  return (
    <div className="bg-bgButtonInactive rounded-2xl flex flex-col p-6 md:p-10 md:px-11 text-left gap-[18px] md:w-[511px] md:mx-auto md:gap-5 xl:w-[389px] xl:gap-6">
