  ...
  return (
    <Dialog.Root open={isOpen} onOpenChange={setIsOpen}>
      <Dialog.Portal>
        ...
        <Dialog.Content
          className={clsx(
            'fixed z-10 transform -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2 max-h-[90vh] w-[90%] sm:w-[440px]  ',
            reviews
              ? 'min-h-[434px] bg-bgButtonInactive p-6 pt-[111px] rounded-lg md:w-[526px] md:min-h-[378px] md:p-8 md:pt-[137px] xl:w-[600px] xl:min-h-[390px]'
              : 'min-h-[600px] bg-bg3 p-6 flex items-center justify-center md:w-[688px] md:h-[700px] md:p-8 xl:w-[1216px] xl:min-h-[755px]'
          )}
        >
